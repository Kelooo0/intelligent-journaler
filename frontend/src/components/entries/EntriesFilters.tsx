      ...
      <section className="filters-form-container">
        <form className="filters-form">
          <section className="sd-container">
            <label className="sd-label" htmlFor="start-date">
              Start date
            </label>
            <input
              className="sd-value"
              ...
              onChange={(event) => setSD(event)}
            ></input>
          </section>
          <section className="ed-container">
            <label className="ed-label" htmlFor="end-date">
              End date
            </label>
            <input
              className="ed-value"
          ...
          <section className="filters-tags-container">
            <section className="add-tag-container">
              <input
                ...
                disabled={filters.tags.length === MAX_TAGS}
              ></input>
              <button
            ...
            <section className="added-tags">
              ...
              {filters.tags.map((tag) => (
                <section className="added-tag-container">
                  <p className="added-tags-item" onClick={() => removeTag(tag)}>
                    #{tag}
                  </p>
                </section>
              ))}
